...
#/home/hanqing/walabot_Research/walabotResearch/test_dataset/walk
...
for video in videos:
    if num_pict>500:
        ...
        while cap.isOpened() and n<15:
            ...
            # cv2.waitKey(100)
            save_path = os.path.join(os.path.dirname(os.path.dirname(cur_dir)),'training_backup/Classfier-position/Train/left')
